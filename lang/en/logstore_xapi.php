...
$string['bestr_custom_deh'] = 'Adds organization data to statements';
$string['bestr_custom_deh_desc'] = 'Insert the name of the field where user organization data is in.';
