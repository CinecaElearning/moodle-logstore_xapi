...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_configtext('logstore_xapi/bestr_custom_deh',
        get_string('bestr_custom_deh', 'logstore_xapi'),
        get_string('bestr_custom_deh_desc', 'logstore_xapi'), '', PARAM_TEXT));
